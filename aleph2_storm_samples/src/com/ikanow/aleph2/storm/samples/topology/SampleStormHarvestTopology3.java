 ...
 *
 */
public class SampleStormHarvestTopology3 implements IStormHarvestTopology {
	...
	public StormTopology getStormTopology(String harvest_context_signature, String job_name, DataBucketBean bucket_bean) {
		...
		builder.setBolt("output", new SampleOutputHDFSBolt(harvest_context_signature)).shuffleGrouping("parser");
